...
\usepackage[left=0.85in, right=0.85in, bottom=0.5in, top=0.4in]{geometry}
...
\end{tabular}
 \vspace{1ex}\\
   \Large{Projects}    &  \href{https://github.com/habibrahmanbd/BanglaPDFtoBanglaDOC}{\textbf{• Bangla PDF to Bangla DOC Converter}} \\
    ...
    & \parbox{5.0in}{Software for Blood Bank Management}\vspace{1ex}\\
    & \href{https://github.com/habibrahmanbd/Game-Rakhal-v1.0/}{\textbf{• Game Rakhal}}\\
    & Year: 2014, Language: JAVA \\
    & \parbox{5.0in}{Desktop Game}\vspace{1ex}\\
 ...
 \Large{Awards} &\textbf{• ACM-ICPC Dhaka Regional-2016} \\
     ...
     & \parbox{5.0in}{Top 10 University Awards}\vspace{1ex}\\
     & \textbf{• Inter University Programming Contest (IUPC), IUT Fest - 2016} \\
     & \parbox{5.0in}{17\textsuperscript{th} Position} \vspace{1ex}\\
     & \textbf{• Intra University Programming Contest, IEEE RUET, Student Branch} \\
     & \parbox{5.0in}{2015, Runners Up} \vspace{1ex}\\
